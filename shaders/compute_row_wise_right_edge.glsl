...
void main()
{
       ...
       setImagePixel(resultImage,image_pixel_cord,-int(a*image_pixel_cord.x/255));
       setImagePixel(resultImage,image_pixel_cord+ivec2(1,0),int(a*(image_pixel_cord.x+1)/255));
