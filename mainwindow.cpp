    ...
    ui(new Ui::MainWindow)
{
    ...
    */
    ...
    connect(ui->marking_laser_on, &QPushButton::clicked,[this]() {QMetaObject::invokeMethod(machine, "MarkingLaser", Qt::QueuedConnection,Q_ARG(int, 2));});
    connect(ui->marking_laser_off, &QPushButton::clicked,[this]() {QMetaObject::invokeMethod(machine, "MarkingLaser", Qt::QueuedConnection,Q_ARG(int, 0));});
    ...
    connect(ui->laser_focus_in, &QPushButton::clicked,[this]() {QMetaObject::invokeMethod(machine, "LaserFocusMotorDiff", Qt::QueuedConnection,Q_ARG(int, 100));});
    connect(ui->laser_focus_out, &QPushButton::clicked,[this]() {QMetaObject::invokeMethod(machine, "LaserFocusMotorDiff", Qt::QueuedConnection,Q_ARG(int, -100));});
    //
